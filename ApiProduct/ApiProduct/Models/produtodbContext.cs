...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<ImagemProduto>(entity => {
                ...
                entity.Property(e => e.CdProduto)
                    ...
                    .HasMaxLength(2000);
                entity.HasOne(e => e.CdProdutoNavigation)
                    .WithMany(d => d.ImagemProduto)
                    .HasForeignKey(e => e.CdProduto)
                    .HasConstraintName("fk_produto_imagemproduto");
            });
        ...
        public DbSet<ApiProduct.Models.ImagemProduto> ImagemProduto { get; set; }
    }
}
